##################################CHANGE01###################################
# IF YOU HAVE NOT INSTALLED FOLLOWING LIBRARIES BEFORE, UNCOMMENT NEXT LINES (REMOVE #) AND INSTALL THEM.
# install.packages(c(
#   "mlr3mbo",
#   "mlr3",
#  "mlr3learners",
...
#   "DiceKriging"
# ))
# AFTER INSTALLING, COMMENT THE LINES.
# %%
library(mlr3mbo)
library(mlr3)
